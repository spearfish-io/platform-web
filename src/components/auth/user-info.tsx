...
export function UserInfo() {
  ...
  // Handle legacy authentication mode
  if (authMode === 'legacy') {
    // For legacy mode, create a mock user from what we know
    const user = {
      id: 'legacy-user',
    ...
    const handleSignOut = async () => {
      // For legacy mode, call the legacy logout API
      try {
            ...
            <Flex align="center" gap="2">
              ...
              <Flex direction="column" align="start" gap="1">
                ...
                <Flex align="center" gap="1">
                  ...
                  <Badge color="orange" size="1">Legacy</Badge>
                </Flex>
              </Flex>
            </Flex>
          </Button>
  ...
  // Handle NextAuth modes (OAuth, etc.)
  if (status === "loading") {
    return (
      <Flex align="center" gap="2">
