      ...
      <Container size="4" p="6">
        ...
        <Box mb="8">
          ...
          <Text size="4" color="gray" mb="4">
            Comprehensive showcase of Platform Web's design principles using Pure Radix UI Themes
          </Text>
        ...
        {/* Design Principles */}
        <Box mb="8">
          <Heading size="6" mb="4">Design Principles</Heading>
          ...
          <Grid columns={{ initial: "1", md: "2" }} gap="4" mb="6">
            <Card size="3">
              <Flex align="start" gap="3">
                ...
                <Box>
                  <Heading size="4" mb="2">Pure Radix UI Themes</Heading>
                  <Text size="2" color="gray" mb="3">
                    All styling achieved exclusively through Radix UI Themes component props. 
                    Zero custom CSS classes or Tailwind utilities in components.
                  </Text>
                  <Badge variant="soft" color="blue" size="1">Mandatory Principle</Badge>
                </Box>
              </Flex>
            </Card>
            ...
            <Card size="3">
              <Flex align="start" gap="3">
                ...
                <Box>
                  <Heading size="4" mb="2">Accessibility-First</Heading>
                  <Text size="2" color="gray" mb="3">
                    WCAG AA compliance mandatory. Semantic HTML, proper ARIA labels, 
                    keyboard navigation, and screen reader compatibility.
                  </Text>
                  <Badge variant="soft" color="green" size="1">Core Requirement</Badge>
                </Box>
              </Flex>
            </Card>
            ...
            <Card size="3">
              <Flex align="start" gap="3">
                ...
                <Box>
                  <Heading size="4" mb="2">Component-Driven</Heading>
                  <Text size="2" color="gray" mb="3">
                    Reusable, composable components following Radix design system. 
                    Each component includes TypeScript interfaces and proper accessibility.
                  </Text>
                  <Badge variant="soft" color="purple" size="1">Architecture</Badge>
                </Box>
              </Flex>
            </Card>
            ...
            <Card size="3">
              <Flex align="start" gap="3">
                ...
                <Box>
                  <Heading size="4" mb="2">Performance-First</Heading>
                  <Text size="2" color="gray" mb="3">
                    Server Components, code splitting, optimized bundles, and comprehensive 
                    performance monitoring with Core Web Vitals.
                  </Text>
                  <Badge variant="soft" color="orange" size="1">Optimization</Badge>
                </Box>
              </Flex>
            </Card>
          </Grid>
        ...
        {/* Color System */}
        <Box mb="8">
          <Heading size="6" mb="4">Color System</Heading>
          <Text size="3" color="gray" mb="6">
            Radix UI Themes provides a comprehensive color system with semantic color scales. 
            All colors are accessible and work in both light and dark themes.
          </Text>

          <Box mb="6">
            <Heading size="4" mb="3">Primary Colors</Heading>
          ...
          <Box mb="6">
            <Heading size="4" mb="3">Surface Colors</Heading>
...
<button className="bg-blue-500 text-white">Button</button>`}
        ...
        {/* Typography System */}
        <Box mb="8">
          <Heading size="6" mb="4">Typography System</Heading>
          <Text size="3" color="gray" mb="6">
            Radix UI Themes provides a structured typography scale with consistent sizing, 
            line heights, and spacing relationships.
          </Text>

          <Box mb="6">
            <Heading size="4" mb="3">Heading Scale</Heading>
          ...
          <Box mb="6">
            <Heading size="4" mb="3">Text Sizes</Heading>
            <Card size="3" p="4">
              <Flex direction="column" gap="3">
                <Text size="4">Large text (size 4) - For prominent descriptions</Text>
                <Text size="3">Body text (size 3) - Standard paragraph text</Text>
                <Text size="2">Small text (size 2) - UI labels and secondary content</Text>
                <Text size="1">Caption text (size 1) - Fine print and metadata</Text>
              </Flex>
            </Card>
          </Box>
...
<Text weight="medium">Emphasized content</Text>`}
        ...
        {/* Spacing System */}
        <Box mb="8">
          <Heading size="6" mb="4">Spacing System</Heading>
          <Text size="3" color="gray" mb="6">
            Consistent spacing scale using Radix UI Themes space tokens. 
            All spacing follows the 4px baseline grid for visual harmony.
          </Text>
...
<Box style={{ padding: "var(--space-5)" }}>Custom spacing</Box>`}
        ...
        {/* Radius and Shadows */}
        <Box mb="8">
          <Heading size="6" mb="4">Radius & Elevation</Heading>
          
          <Grid columns={{ initial: "1", md: "2" }} gap="6">
            <Box>
              <Heading size="4" mb="3">Border Radius</Heading>
              <Flex direction="column" gap="3">
                <DesignToken
                  name="Radius 1"
                  value="--radius-1 (2px)"
            ...
            <Box>
              <Heading size="4" mb="3">Card Sizes</Heading>
              <Flex direction="column" gap="3">
                <Card size="1" p="3">
        ...
        <Box mb="8">
          <Heading size="6" mb="4">Implementation Guidelines</Heading>
          
          <Grid columns={{ initial: "1", lg: "2" }} gap="4">
            <Card size="3" style={{ background: "var(--green-2)", border: "1px solid var(--green-6)" }}>
              <Heading size="4" color="green" mb="3">✅ Best Practices</Heading>
              <Flex direction="column" gap="2">
                <Text size="2" color="green">• Use ONLY Radix UI Themes components and props</Text>
                <Text size="2" color="green">• Leverage color, size, variant props for styling</Text>
                <Text size="2" color="green">• Use CSS variables for custom values when needed</Text>
                <Text size="2" color="green">• Follow semantic HTML structure</Text>
                <Text size="2" color="green">• Test with keyboard navigation and screen readers</Text>
              </Flex>
            </Card>
            ...
            <Card size="3" style={{ background: "var(--red-2)", border: "1px solid var(--red-6)" }}>
              ...
              <Flex direction="column" gap="2">
                <Text size="2" color="red">• Custom CSS classes for visual styling</Text>
                <Text size="2" color="red">• Tailwind utility classes in component JSX</Text>
                <Text size="2" color="red">• Inline styles for color and spacing</Text>
                <Text size="2" color="red">• Non-semantic HTML structure</Text>
                <Text size="2" color="red">• Missing accessibility attributes</Text>
              </Flex>
            </Card>
          </Grid>
        </Box>
        ...
        {/* Quick Actions */}
        <Box>
          <Heading size="5" mb="4">Explore More</Heading>
